...
```
                    ...
                    "Where are we going?"
                             ...
                             │
             🟢 WEST ────────┼──────── 🟠 EAST
          The Pragmatist     │        The Challenger
        "How will this work?"│     "What's emerging?"
                             │
                             │
                        🟤 SOUTH (Earth)
                         The Sage
...
The power of the Four Directions comes from the **structural tension** built into the compass:

| Axis | Elements | Tension | What It Surfaces |
|------|----------|---------|------------------|
| **North ↔ South** | Air ↔ Earth | Future vs. Past | Where we're going vs. what we know |
| **East ↔ West** | Fire ↔ Water | Transform vs. Adapt | Disrupt the old vs. execute what works |
...
The Four Directions are the foundation, but SPAR supports domain-specific personas as well. See the [Persona Library](./PERSONA_LIBRARY.md) for ready-to-use alternatives for:

- Strategic Business Decisions
- Hiring & Team Decisions
- Product Decisions
- Personal Career Decisions
- Research & Innovation Decisions

---

> **நாலு பேரு, நாலு திசை, ஒரு முடிவு**
> *Four Perspectives, Four Directions, One Synthesis*

## The Elemental Foundation

| Direction | Element | Color | Hex | Quality |
|-----------|---------|-------|-----|---------|
| **North** | Air | Sky Blue | #4A90D9 | Rising, aspirational |
| **East** | Fire | Flame Orange | #E85D04 | Transforming, urgent |
| **West** | Water | Deep Teal | #1D7874 | Flowing, adaptive |
| **South** | Earth | Rich Brown | #8B5A2B | Rooted, grounded |

**The Axis Pairs:**
- **Air ↔ Earth (N-S)**: Future vs. Past (Temporal tension)
- **Fire ↔ Water (E-W)**: Transform vs. Adapt (Method tension)

---

*The compass doesn't tell you where to go. It shows you where you are.* 🧭
